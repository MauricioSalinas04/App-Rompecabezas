...
class ImportWindow:
    ...
    def start_process(self):
        ...
        # crear diccionario para identificar el rompecabezas solo con tener el grupo
            # CICLO CON LA CANTIDAD DE GRUPOS QUE HAY
                # leer cada registro de vectores correctos en el rango de registros
            # CREAR GRID
            # PONER CUADROS EN BASES
            
            # ordenar data_relacion_grupos en en base a grupos, de esta manera tendremos los registros del 1-N
            # data_vectores_correctos ordenados 1-N
            # data_vectores_promedios ordenados 1-N

            # Hacer un ciclo que pase en un rango de 1-N
             # por cada registro obtener pattern = data_relacion_grupos[i]
             # obtener coordenadas de cuadros de ese patron
             # crear un grid
             # marcar flechas negras (desde origen la coordenada de cada cuadro y destino esas mismas coordenadas sumadas con los vectores)
             # marcar flechas azules ()
             # marcar flechas rojas  ()
             # plasmar los cuadros
             #  exportar imagen
             # siguiente registro